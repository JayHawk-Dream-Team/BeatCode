		...
		<>
			...
			<div className='w-full sm:w-[450px]  absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]  flex justify-center items-center'>
				<div className='relative w-full h-full mx-auto flex items-center justify-center'>
					<div className='rounded-lg shadow-xl relative w-full mx-6 border border-outline-variant/15' style={{
						...
						<div className='flex justify-end p-2'>
							<button
								type='button'
								className='rounded-lg text-sm p-1.5 ml-auto inline-flex items-center transition-all hover:bg-surface-container text-on-surface-variant hover:text-on-surface'
								onClick={closeModal}
							>
